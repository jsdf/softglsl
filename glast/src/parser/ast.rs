...
impl Type {
    ...
    pub(crate) fn parse_var_idents(expr: &Expr) -> Option<Vec<(Ident, Vec<ArrSize>)>> {
        ...
        match &expr.ty {
            ExprTy::Ident(_) | ExprTy::Index { .. } => convert(expr).map(|i| vec![i]),
            ExprTy::List { items } => {
                let mut v = Vec::new();
                for item in items {
...
impl Primitive {
    ...
    pub fn parse(ident: &Ident) -> Self {
        match ident.name.as_ref() {
            ...
            "sampler2DRect" => Primitive::Sampler(Fundamental::Float, TexType::D2Rect),
            "sampler1DArray" => Primitive::Sampler(Fundamental::Float, TexType::D1Array),
            "sampler2DArray" => Primitive::Sampler(Fundamental::Float, TexType::D2Array),
            ...
            "sampler2DMS" => Primitive::Sampler(Fundamental::Float, TexType::D2Multisample),
            "sampler2DMSArray" => {
            ...
            "isampler2DRect" => Primitive::Sampler(Fundamental::Int, TexType::D2Rect),
            "isampler1DArray" => Primitive::Sampler(Fundamental::Int, TexType::D1Array),
            "isampler2DArray" => Primitive::Sampler(Fundamental::Int, TexType::D2Array),
            ...
            "isampler2DMS" => Primitive::Sampler(Fundamental::Int, TexType::D2Multisample),
            "isampler2DMSArray" => {
            ...
            "usampler2DRect" => Primitive::Sampler(Fundamental::UInt, TexType::D2Rect),
            "usampler1DArray" => Primitive::Sampler(Fundamental::UInt, TexType::D1Array),
            "usampler2DArray" => Primitive::Sampler(Fundamental::UInt, TexType::D2Array),
            ...
            "usampler2DMS" => Primitive::Sampler(Fundamental::UInt, TexType::D2Multisample),
            "usampler2DMSArray" => {
                Primitive::Sampler(Fundamental::UInt, TexType::D2MultisampleArray)
            }
            "sampler1DShadow" => Primitive::Sampler(Fundamental::Float, TexType::D1Shadow),
            "sampler2DShadow" => Primitive::Sampler(Fundamental::Float, TexType::D2Shadow),
            "samplerCubeShadow" => Primitive::Sampler(Fundamental::Float, TexType::CubeShadow),
            "sampler2DRectShadow" => Primitive::Sampler(Fundamental::Float, TexType::D2RectShadow),
            ...
            "image2DRect" => Primitive::Image(Fundamental::Float, TexType::D2Rect),
            "image1DArray" => Primitive::Image(Fundamental::Float, TexType::D1Array),
            "image2DArray" => Primitive::Image(Fundamental::Float, TexType::D2Array),
            ...
            "image2DMS" => Primitive::Image(Fundamental::Float, TexType::D2Multisample),
            "image2DMSArray" => Primitive::Image(Fundamental::Float, TexType::D2MultisampleArray),
            ...
            "iimage2DRect" => Primitive::Image(Fundamental::Int, TexType::D2Rect),
            "iimage1DArray" => Primitive::Image(Fundamental::Int, TexType::D1Array),
            "iimage2DArray" => Primitive::Image(Fundamental::Int, TexType::D2Array),
            ...
            "iimage2DMS" => Primitive::Image(Fundamental::Int, TexType::D2Multisample),
            "iimage2DMSArray" => Primitive::Image(Fundamental::Int, TexType::D2MultisampleArray),
            ...
            "uimage2DRect" => Primitive::Image(Fundamental::UInt, TexType::D2Rect),
            "uimage1DArray" => Primitive::Image(Fundamental::UInt, TexType::D1Array),
            "uimage2DArray" => Primitive::Image(Fundamental::UInt, TexType::D2Array),
            ...
            "uimage2DMS" => Primitive::Image(Fundamental::UInt, TexType::D2Multisample),
            "uimage2DMSArray" => Primitive::Image(Fundamental::UInt, TexType::D2MultisampleArray),
...
impl Lit {
    ...
    pub fn parse(token: &Token, span: Span) -> Result<Self, (Self, Syntax)> {
        ...
        match token {
            ...
            Token::Num {
                ...
                if s == "" {
                    return Err((Self::InvalidNum, Syntax::Expr(ExprDiag::EmptyNumber(span))));
                }
                match type_ {
            ...
            _ => unreachable!("This function should only be given a `Num` or `Bool` token."),
        }
    }

    fn parse_num_dec(s: &str, suffix: Option<&str>, span: Span) -> Result<Self, (Self, Syntax)> {
        use crate::diag::ExprDiag;
    ...
    fn parse_num_hex(s: &str, suffix: Option<&str>, span: Span) -> Result<Self, (Self, Syntax)> {
        use crate::diag::ExprDiag;
    ...
    fn parse_num_oct(s: &str, suffix: Option<&str>, span: Span) -> Result<Self, (Self, Syntax)> {
        use crate::diag::ExprDiag;
    ...
    fn parse_num_float(s: &str, suffix: Option<&str>, span: Span) -> Result<Self, (Self, Syntax)> {
        use crate::diag::ExprDiag;
